			...
			<main>
				<Row className="my-3">
					<Col className="text-center">
						<h1 className="text">KyotoCarbon NFT Drop</h1>
						<p className="countdown">
							{revealTime !== 0 && <Countdown date={currentTime + (revealTime - currentTime)} />}
						</p>
						<p>Mint your free KyotoCarbon limited edition inaugural NFT on 3rd December 2021. Each NFT is backed by 1kgCO2e of carbon credit</p>
					</Col>
				</Row>
				<Row className="my-4">
